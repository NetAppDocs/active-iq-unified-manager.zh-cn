...
此外，在安装第二个 Unified Manager 实例之前，单个 Unified Manager 实例可以监控的节点数量是有限制的。有关节点限制、CPU 和内存建议，请参阅 https://www.netapp.com/pdf.html?item=/media/13504-tr4621pdf.pdf["统一管理最佳实践指南"^]。
