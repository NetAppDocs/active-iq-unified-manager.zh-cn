...
* Red Hat Enterprise Linux 或 CentOS 7.x 和 8.x 版，基于 x86_64 架构。不支持 CentOS 流。
...
NOTE: NetApp 不支持使用 Microsoft System Center Configuration Manager （ SCCM ）等第三方工具安装 Unified Manager 。
...
* MySQL Community Edition 8.0.27 版（从 MySQL 存储库）。
* OpenJDK 11.0.12 版（来自 Red Hat Extra Enterprise Linux Server 存储库）
* Python 3.6.x
