...
[role="lead"]
您可以通过在Linux平台上下载并运行安装文件从Unified Manager 9.10或9.11升级到9.12。
...
* 在 Unified Manager 升级期间， MySQL Community Edition 会自动升级。如果系统上安装的MySQL版本早于8.0.30、则Unified Manager升级过程会自动将MySQL升级到8.0.30。
