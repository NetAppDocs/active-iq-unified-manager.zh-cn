...
* Red Hat Enterprise Linux 8.x 和 9.6 版本，基于 x86_64 架构。
...
* MySQL 社区版 8.4.7 版（来自 MySQL 存储库）
* OpenJDK 版本 17.0.14+6（来自 Red Hat Extra Enterprise Linux Server 存储库）
* Python 3.13.3（来自 Red Hat Extra Enterprise Linux Server 存储库）
* 7zip 版本 7z2301-linux-x64。更多信息，请查看 link:task_configure_7zip_package.html["配置 7-zip 软件包"]。
